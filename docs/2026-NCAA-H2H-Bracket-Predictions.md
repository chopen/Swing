...
**Close-metrics rule:** When the combined MVIX + MRVI difference between two teams is less than 8, the higher-seeded team receives a 2x weight bonus. This prevents the model from picking upsets based on negligible metric differences.
...
|---|---|---|---|---|---|---|---|
| EAST | (1) DUKE vs (16) SIE | 50 | 50 | 46 | 52 | **DUKE** | MRVI SIE, MVIX SIE, seed (1v16), close (<8), seed (1) |
...
| EAST | (5) SJU vs (12) UNI | 47 | 50 | 46 | 54 | **SJU** | MRVI UNI, MVIX UNI, seed (5v12), close (<8), seed (5), seed tiebreak |
...
| WEST | (5) WIS vs (12) HPU | 50 | 53 | 54 | 51 | **WIS** | MRVI WIS, MVIX WIS, seed (5v12), close (<8), seed (5) |
| WEST | (6) BYU vs (11) SMU | 58 | 53 | 54 | 52 | **BYU** | MRVI BYU, MVIX SMU, seed (6v11), close (<8), seed (6) |
...
| SOUTH | (2) HOU vs (15) IDHO | 52 | 51 | 59 | 50 | **HOU** | MRVI HOU, MVIX HOU, seed (2v15), close (<8), seed (2) |
| SOUTH | (3) ILL vs (14) PENN | 61 | 47 | 57 | 50 | **ILL** | MRVI PENN, MVIX PENN, seed (3v14), close (<8), seed (3) |
| SOUTH | (4) NEB vs (13) TROY | 45 | 48 | 45 | 51 | **NEB** | MRVI TROY, MVIX NEB, seed (4v13), close (<8), seed (4) |
...
| SOUTH | (8) CLEM vs (9) IOWA | 58 | 46 | 62 | 42 | **CLEM** | MRVI CLEM, MVIX CLEM, close (<8), seed (8) |
| MIDWEST | (1) MICH vs (16) UMBC | 49 | 50 | 48 | 51 | **MICH** | MRVI UMBC, MVIX UMBC, seed (1v16), close (<8), seed (1) |
...
| Region | Matchup | MVIX | MRVI | MVIX | MRVI | Pick | Signal |
|---|---|---|---|---|---|---|---|
| EAST | (1) DUKE vs (8) OSU | 50 | 50 | 56 | 54 | **DUKE** | MRVI OSU, MVIX DUKE, seed (1v8), seed tiebreak |
| EAST | (4) KU vs (5) SJU | 49 | 46 | 47 | 50 | **SJU** | MRVI SJU, MVIX SJU, close (<8), seed (4) |
| EAST | (14) NDSU vs (11) USF | 43 | 50 | 48 | 54 | **USF** | MRVI USF, MVIX NDSU |
| EAST | (2) CONN vs (7) UCLA | 50 | 47 | 48 | 48 | **CONN** | MRVI UCLA, MVIX UCLA, seed (2v7), close (<8), seed (2), seed tiebreak |
| WEST | (16) LIU vs (9) USU | 56 | 49 | 66 | 53 | **USU** | MRVI USU, MVIX LIU, seed (9v16) |
| WEST | (4) ARK vs (5) WIS | 50 | 53 | 50 | 53 | **ARK** | MVIX ARK, close (<8), seed (4) |
| WEST | (3) GONZ vs (6) BYU | 50 | 53 | 58 | 53 | **GONZ** | MVIX GONZ |
| WEST | (2) PUR vs (7) MIA | 56 | 47 | 55 | 52 | **PUR** | MRVI MIA, MVIX MIA, seed (2v7), close (<8), seed (2), seed tiebreak |
...
| Region | Matchup | MVIX | MRVI | MVIX | MRVI | Pick | Signal |
|---|---|---|---|---|---|---|---|
| EAST | (1) DUKE vs (5) SJU | 50 | 50 | 47 | 50 | **DUKE** | MRVI SJU, MVIX SJU, seed (1v5), close (<8), seed (1), seed tiebreak |
...
| MIDWEST | (1) MICH vs (12) AKR | 49 | 50 | 50 | 54 | **MICH** | MRVI AKR, MVIX MICH, seed (1v12), close (<8), seed (1) |
| MIDWEST | (6) TENN vs (2) ISU | 50 | 52 | 49 | 53 | **ISU** | MRVI ISU, MVIX ISU, seed (2v6), close (<8), seed (2) |
...
| Region | Matchup | MVIX | MRVI | MVIX | MRVI | Pick | Signal |
|---|---|---|---|---|---|---|---|
| EAST | (1) DUKE vs (11) USF | 50 | 50 | 48 | 54 | **DUKE** | MRVI USF, MVIX USF, seed (1v11), close (<8), seed (1) |
| WEST | (4) ARK vs (3) GONZ | 50 | 53 | 50 | 53 | **GONZ** | MRVI GONZ, close (<8), seed (3) |
| SOUTH | (5) VAN vs (6) UNC | 62 | 53 | 40 | 57 | **UNC** | MRVI UNC, MVIX UNC |
| MIDWEST | (1) MICH vs (2) ISU | 49 | 50 | 49 | 53 | **MICH** | MRVI ISU, MVIX MICH, close (<8), seed (1) |
...
| Region | Matchup | MVIX | MRVI | MVIX | MRVI | Pick | Signal |
|---|---|---|---|---|---|---|---|
| FF | (1) DUKE vs (3) GONZ | 50 | 50 | 50 | 53 | **GONZ** | MRVI GONZ, MVIX GONZ, close (<8), seed (1) |
...
## Analysis generated March 16, 2026 | 90-day backfill | 7,946 CBB records | 100% MRVI coverage | Close-metrics threshold: 8

## Disclaimer

Predictions based on momentum volatility metrics from play-by-play data. Does not account for injuries, venue, travel, or team quality ratings. Use as one analytical signal among many.
